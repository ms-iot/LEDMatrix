...
void setup()
{
//  Serial.begin(9600);     // Set up the internal serial line for debugging output
  
//  delay(5000);
//  Serial.println("Debug output is working");

  Serial.begin(115200);   // Use Serial1 (hardware serial) on the Leonardo for actual communication
